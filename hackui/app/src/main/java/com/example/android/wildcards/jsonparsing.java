...
/**
 * Created by archi on 11-02-2017.
 */
    ...
    private static Event extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            JSONObject baseJsonResponse = new JSONObject(earthquakeJSON);
                String sleep_hrs = baseJsonResponse.getString("sleep_hours");
                String work_hrs = baseJsonResponse.getString("work_hours");
                String free_time=   baseJsonResponse.getString("freetime");
                String hol_peryear = baseJsonResponse.getString("holperyear");
